...
builder.Services.Configure<IdentityOptions>(options =>
{
    ...
    // Username benzersizliği kapalı, Email benzersizliği açık
...
using (var scope = app.Services.CreateScope())
{
    try
    {
        ...
        // Admin kullanıcısı oluştur (Proje gereksinimleri için)
